...
$status_steps = [
    ...
    ['id' => 3, 'text' => 'Pronto para Retirada', 'icon' => 'fa-box-open'],
    ['id' => 4, 'text' => 'Retirado', 'icon' => 'fa-check']
];
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<div class="container my-5">
    ...
    <div class="card card-premium p-4 border-start border-5 border-primary">
        ...
        <div class="mb-0">
            ...
            <p class="mb-0">Tipo: Retirada no Balcão</p>
            <p class="mb-0">Cliente: <?= $cliente->nome ?></p>
        </div>
    </div>
