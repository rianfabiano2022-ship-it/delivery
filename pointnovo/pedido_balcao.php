...
// Config empresa
$stmt_empresa = $connect->prepare("SELECT Chave_Pix, timerdelivery, celular, rua, bairro, numero FROM config WHERE id = :id LIMIT 1");
...
$msg = "NOVO PEDIDO (RETIRADA NO BALCÃO) - ".$id_pedido."\n*Data:* ".$pedido->data."\n*Hora:* ".$pedido->hora."\n\nDADOS DO PEDIDO\n\n";
...
$msg .= "\nDADOS DA RETIRADA NO BALCÃO\n*Cliente:* ".$cliente->nome."\n*Contato:* ".$cliente->telefone."\n*Endereço do Estabelecimento:* ".$dadosempresa->rua." - ".$dadosempresa->numero." - ".$dadosempresa->bairro."\n\n";
...
$msg .= "*Taxa:* Grátis\n"; // Taxa de entrega é sempre grátis para retirada no balcão
$msg .= "*Total:* R$ ".number_format($pedido->vtotal,2,',',' ')."\n";
if ($pedido->troco>0) $msg .= "*Troco para:* R$ ".number_format($pedido->troco,2,',','.')."\n";
?>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-9 col-md-10">
            ...
            <div class="text-center mb-4">
                ...
                <p class="text-muted fs-6">Seu pedido está sendo preparado para retirada.</p>
            </div>

            <div class="card card-premium mb-4 p-4" style="border-left:5px solid #0d6efd;">
                <div class="section-title"><i class="fa fa-user"></i> Cliente & Retirada</div>
                <p><b>Nome:</b> <?= htmlspecialchars($cliente->nome) ?></p>
                <p><b>Contato:</b> <?= htmlspecialchars($cliente->telefone) ?></p>
                <hr>
                <p class="mb-1"><b>Endereço para Retirada:</b></p>
                <p class="text-muted"><?= htmlspecialchars($dadosempresa->rua) ?>, <?= htmlspecialchars($dadosempresa->numero) ?> - <?= htmlspecialchars($dadosempresa->bairro) ?></p>
            ...
            <div class="card card-premium mb-4 p-4" style="border-left:5px solid #ffc107;">
                ...
                <div class="d-flex justify-content-between mb-1"><span>Taxa de Entrega:</span><span>Grátis</span></div>
            ...
            <div class="d-grid gap-2 mb-3">
                ...
                <a href="acompanhar_balcao.php?id=<?= $id_pedido ?>" class="btn btn-outline-primary btn-lg"><i class="fa fa-eye"></i> Acompanhar Pedido</a>
